YUI.add('gallery-y3d', function (Y, NAME) {
...
(function (factory) {
    ...
    factory(Y.namespace('WebGLMatrix'));
...
Y.WebGLAnim = WebGLAnim;Y.Camera = Y.Base.create('camera', Y.y3d.Model, [], {
	initializer: function() {
		var instance = this;
...
Y.Color = Y.mix(Color, Y.Color);Y.Box = Y.Base.create('box', Y.Geometry, [], {
	initializer: function() {
		var instance = this,
...
Y.namespace("Plugin").Picker = Picker;var colorProgram = null,
	textureProgram = null,
