YUI.add("picker", function(Y) {
    ...
    Y.extend(Picker, Y.Plugin.Base, {
        ...
        pick: function(x, y) {
            ...
            var color = readout[0].toString(16) + readout[1].toString(16) + readout[2].toString(16);
        ...
        _bindFrameBuffer: function() {
            ...
            if (!frameBuffer) {
                var width = host.get('width');
                var height = host.get('height'),
